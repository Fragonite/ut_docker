...
crudini --set --ini-options=nospace ../build/inis/System64/User.ini Botpack.ChallengeBotInfo bAdjustSkill True
...
crudini --set --ini-options=nospace ../build/inis/System64/UnrealTournament.ini Botpack.DeathMatchPlus FragLimit 3
