...
# AMD64
CMD ["./System64/ucc-bin-amd64", "Server", "DM-Deck16][?mutator=fnn262.GiveWeapons,fnn262.SpecIdlers,fnn262.NoItemsMap,fnn262.CmdMut,fnn262.ScoreSave", "-lanplay", "-nohomedir"]
# AMD64 END