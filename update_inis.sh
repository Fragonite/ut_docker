...
crudini --set --ini-options=nospace ../build/inis/System/User.ini Botpack.ChallengeBotInfo bAdjustSkill False
...
crudini --set --ini-options=nospace ../build/inis/System/UnrealTournament.ini Botpack.DeathMatchPlus MinPlayers 4
...
crudini --set --ini-options=nospace ../build/inis/System/UnrealTournament.ini Botpack.DeathMatchPlus NetWait 1
